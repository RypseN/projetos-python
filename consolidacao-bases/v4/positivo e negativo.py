# ============================================
# Projeto: Consolidação de Remarcados Linx
# Versão: 2.0
# Data: 14/08/2025
# Autor: Roberto Junior
# Regras:
#   - Remarcado: Estoque Atual != 0 (Removemos apenas o que o valor for =0)
#   - Não Remarcado: Estoque Atual >= 10 Condição ajustavel 
# Observações:
#   - Ignorar 'Aumento de Preço'
# ============================================
...
estoque_minimo_nao_remarcado = 11  # Altere aqui o valor mínimo para NÃO REMARCADO
